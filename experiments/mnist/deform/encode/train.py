...
def train_and_evaluate( cfg: Any, output_dir: str ):
  ...
  exp_name     =  "niso_{}_kopd_{}_ld_{}d_mnist_elastic_deformation".format(cfg.KERNEL_OP_DIM, cfg.LATENT_DIM, len(cfg.CONV_ENC_CHANNELS)-1, cfg.DATASET_NAME)  
  ...
  wandb.log({"dataset": "MNIST", "transformation": "elastic_deformation", "alpha": alpha, "sigma": sigma})
  ...
  xform = xforms.ElasticDeform(alpha=alpha, sigma=sigma)
...
if __name__ == '__main__':
  ...
  alpha_equiv = float(arguments['--ae'])  
