...
export DATA_DIR="data/shrec11_aug/processed_dropout/"

python3 experiments/shrec11/dropout/combine.py --data $DATA_DIR
python3 experiments/shrec11/dropout/encode/train.py --in $DATA_DIR --out "logs/$SLURM_JOB_ID/"
python3 experiments/shrec11/dropout/predict/train.py \
  --in $DATA_DIR \
