...
export DATA_DIR="data/shrec11_aug/processed_elastic/"

python3 experiments/shrec11/deform/combine.py --data $DATA_DIR
python3 experiments/shrec11/deform/encode/train.py --in $DATA_DIR --out "logs/$SLURM_JOB_ID/"
python3 experiments/shrec11/deform/predict/train.py \
  --in $DATA_DIR \
