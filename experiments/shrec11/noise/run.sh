...
export DATA_DIR="data/shrec11_aug/processed_noisy/"

python3 experiments/shrec11/noise/combine.py --data $DATA_DIR
python3 experiments/shrec11/noise/encode/train.py --in $DATA_DIR --out "logs/$SLURM_JOB_ID/"
python3 experiments/shrec11/noise/predict/train.py \
  --in $DATA_DIR \
